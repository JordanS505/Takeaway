...
<body>
	...
	<div class="container-fluid">
		<div class="row gx-3 gap-4">
			...
			<div class="sidebar col-12 col-md-3 mb-3 border-0 rounded-5 shadow p-3" style="height: fit-content; min-height: 150px; position: sticky; top: 90px; height: fit-content;">
				<h2 class="fw-bold">🛒 Il tuo carrello</h2>
				<div id="cart-items" class="mb-2 text-muted">Nessun elemento nel carrello</div>
				<hr>
				<div class="d-flex justify-content-between">
			        <strong>Totale:</strong>
			        <strong>€<span id="cart-total">0.00</span></strong>
			    </div>
			    <button class="btn w-100 border-radius border-0 rounded-pill text-white mt-2" style="background-color: #c1280f">Ordina ora!</button>
			</div>
			            ...
			            %>
			                <div class="card mb-3 p-3 border-0 shadow rounded-5">
			                    ...
			                    <div class="row d-flex">
			                    	<div class="col-3">
			                    		<img src="<%= portata.getFoto() %>" alt="Foto Portata" class="img-fluid flex-shrink-0 img-ristorante" style="object-fit: cover; height: 200px;">
			                   		</div>
			                        <div class="col-5">
			                            <h5 class="mb-1"><%= portata.getNome() %></h5><br>
			                            <span class="mb-0 text-muted"><%= prezzo %>€</span>
			                        </div>
									<div class="col-4 d-flex flex-column align-items-end">
									    <div class="d-flex gap-1 align-items-center">
									    	<span class="fw-bold mt-2">Quantità:</span>
									    	<span class="quantity mt-2" data-nome="<%= portata.getNome() %>">0</span>
									    </div>
									    <div class="d-flex me-2 gap-1 align-items-center">
									        <button class="btn btn-outline-danger border-2 btn-minus fw-bold fs-5" style="padding: 0; width: 35px; height: 35px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">−</button>
									        <button class="btn btn-outline-success border-2 btn-plus fw-bold fs-5" style="padding: 0; width: 35px; height: 35px; border-radius: 50%; display: flex; align-items: center; justify-content: center;">+</button>
									    </div>
									</div>				
			                    </div>
			                </div>
